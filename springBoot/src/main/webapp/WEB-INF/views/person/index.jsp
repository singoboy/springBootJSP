        ...
        <tbody>
            <c:forEach items="${persons}" var="person" varStatus="itr">
                <tr>
                    ...
                    <td>${person.email}</td>
                    <td>${person.mobile}</td>
                    <td><a href="${pageContext.request.contextPath}/person/edit/${person.id}" class="btn btn-warning">Edit</a> </td>
                </tr>
            </c:forEach>
        </tbody>

    </table>
    <a href="${pageContext.request.contextPath}/person/create" class="btn btn-success">Add Person</a>
